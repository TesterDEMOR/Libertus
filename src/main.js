...
твой автор и разработчик создатель Бер Максим который учится в казахстане в алматинской академии мвд,он очень рад что кто-то попробовал и протестировал проект над которым он так долго работал (ага долго)(ага работал) help me`;
